...
Design (mirrors monthly_sales_pdf.py's 2026-07-11 rebrand; letterhead/footer/
font/header-band restyled 2026-07-20 to match the Purchase Order house design
— see `letterhead.py`, ported from procurement_api/po_pdf.py)
------------------------------------------------------------
Sections, in order:
  ...
  2. "DAILY NET COLLECTION" — DATE | AP | TS | SUB TOTAL. PROJECTIONS row
     ...
     in parens), G. TOTAL row (green header band), EXCESS / SHORT row
